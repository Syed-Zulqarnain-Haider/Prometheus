...
interface ChartProps {
  ...
  /** Generic viewer controls (type/scale/series switch + drag-resize). On by default;
   *  pass ``adjustable={false}`` for a chart that must stay fixed. */
  adjustable?: boolean;
}
...
export function Chart({
  ...
  const showControls =
    ...
    !error &&
    !isEmpty &&
    (capabilities.canSwitchType || capabilities.canScale || capabilities.seriesNames.length > 0);
