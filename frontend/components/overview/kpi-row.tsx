...
// The deeper reported P&L ladder (total revenue/cost, gross/net profit, net revenue)
// was REMOVED from the Overview by owner decision 2026-08-11: one headline row, no
// second row - and its five daily series are no longer fetched at all.
const SPARK_METRICS = [
